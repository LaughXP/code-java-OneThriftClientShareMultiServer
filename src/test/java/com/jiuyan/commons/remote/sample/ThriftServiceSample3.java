...
public class ThriftServiceSample3 {

  public interface Iface {

    public String add() throws org.apache.thrift.TException;

    public String update(String methodName, long fromTime, long toTime) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void add(org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void update(String methodName, long fromTime, long toTime, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_add() throws org.apache.thrift.TException
    {
    ...
    public String update(String methodName, long fromTime, long toTime) throws org.apache.thrift.TException
    {
      send_update(methodName, fromTime, toTime);
      return recv_update();
    }

    public void send_update(String methodName, long fromTime, long toTime) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void add(org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      add_call method_call = new add_call(resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class add_call extends org.apache.thrift.async.TAsyncMethodCall {
      public add_call(org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public void update(String methodName, long fromTime, long toTime, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      update_call method_call = new update_call(methodName, fromTime, toTime, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class update_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private long toTime;
      public update_call(String methodName, long fromTime, long toTime, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class update<I extends Iface> extends org.apache.thrift.ProcessFunction<I, update_args> {
      ...
      public update_result getResult(I iface, update_args args) throws org.apache.thrift.TException {
        update_result result = new update_result();
        result.success = iface.update(args.methodName, args.fromTime, args.toTime);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class update<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, update_args, String> {
      ...
      public void start(I iface, update_args args, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws TException {
        iface.update(args.methodName, args.fromTime, args.toTime,resultHandler);
      }
    }
...
;
  ...
  public static class update_args implements org.apache.thrift.TBase<update_args, update_args._Fields>, java.io.Serializable, Cloneable, Comparable<update_args>   {
    ...
    public update_args setMethodName(String methodName) {
      this.methodName = methodName;
      return this;
    }
    ...
    public update_args setFromTime(long fromTime) {
      this.fromTime = fromTime;
      setFromTimeIsSet(true);
      return this;
    }
    ...
    public update_args setToTime(long toTime) {
      this.toTime = toTime;
      setToTimeIsSet(true);
      return this;
    }
